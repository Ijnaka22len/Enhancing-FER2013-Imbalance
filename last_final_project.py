# -*- coding: utf-8 -*-
"""Last_Final_Project_complete.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Rq88hMT2ob8sUiMAisEvoKBFO0ZqesAN
...
working_dir = '/content/drive/MyDrive/CU/Fall2023/DeepLearningCS570/Final_Project/' # If we have to both edit using this same notebook, you can download these files to your respective drives and connect to the dataset from your google drive.
...
#*********************************************************************************
def plotConfusionMatrix(model=None, X_test=None, y_test=None, plt=None, np=None):
...
#*******************************************************************************
def sampleAugmentationPlotOnly():
...
**Steps:**
- Splitting dataset into 3 parts: Training: **80%**, Validation: **10% **& Testing: **10%** :Part 3 of  `preProccess_augment()`
- Convert strings to lists of integers: Part 1 of  `preProccess_augment()`
- Reshape to 48x48x1 and normalise grayscale image with 255.0: Part 1 of   `preProccess_augment()`
-  Perform one-hot encoding label, e.g. class 3 to [0,0,0,1,0,0,0]: Part 4 of `preProccess_augment()`
- Oversampling minority classes : `preProccess_augment()`
- Data augmentation: `preProccess_augment()`
"""
...
history_path = working_dir+f'checkpoint/best_model_history_{str(current_time).split(" ")[0]}.pkl'
...
# (_, _), (_, _), (X_test, y_test) = preProccess_augment(file_path=working_dir+'fer2013.csv',datagen=datagen, target_samples=1)

import os
os.listdir(working_dir+'checkpoint')

loaded_model = load_model(working_dir + 'checkpoint/best_model_2023-12-28.h5', {'Activation': Activation} )

"""**Visualize Training Performance of loaded CNN model**"""

history_path= working_dir + "checkpoint/best_model_history_2023-12-28.pkl"
